 ...
 */
@XmlRootElement
public final class CompuwareSecurityRoleCreatedEvent extends CompuwareSecurityRoleEvent {
     ...
     * 
     */
    protected CompuwareSecurityRoleCreatedEvent() {
        super();
    }
     ...
     * @param realmName
     */
    public CompuwareSecurityRoleCreatedEvent(
        ...
        super(
            ...
            originatingHostname,
            "Created SecurityRole: [" + securityRole.getRoleName() + "].",
            realmName);
    }
}