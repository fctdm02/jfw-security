 ...
 */
@XmlRootElement
public final class CompuwareSecurityUserCreatedEvent extends CompuwareSecurityUserEvent {
     ...
     * 
     */
    protected CompuwareSecurityUserCreatedEvent() {
        super();
    }
     ...
     * @param realmName
     */
    public CompuwareSecurityUserCreatedEvent(
        ...
        super(
            ...
            originatingHostname,
            "Created " + abstractUser.getClass().getSimpleName() + ": [" + abstractUser.getUsername() + "].",
            realmName);
    }
}