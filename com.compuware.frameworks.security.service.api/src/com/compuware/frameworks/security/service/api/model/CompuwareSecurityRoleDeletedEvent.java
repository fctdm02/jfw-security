 ...
 */
@XmlRootElement
public final class CompuwareSecurityRoleDeletedEvent extends CompuwareSecurityRoleEvent {
     ...
     * 
     */
    protected CompuwareSecurityRoleDeletedEvent() {
        super();
    }
     ...
     * @param realmName
     */
    public CompuwareSecurityRoleDeletedEvent(
        ...
        super(
            ...
            originatingHostname,
            "Deleted SecurityRole: [" + securityRole.getDisplayName() + "].",
            realmName);
    }
}