 ...
 */
@XmlRootElement
public final class CompuwareSecurityPasswordPolicyCreatedEvent extends CompuwareSecurityPasswordPolicyEvent {
     ...
     * 
     */
    protected CompuwareSecurityPasswordPolicyCreatedEvent() {
        super();
    }
     ...
     * @param realmName
     */
    public CompuwareSecurityPasswordPolicyCreatedEvent(
        ...
        super(
            ...
            originatingHostname,
            "Created PasswordPolicy: [" + passwordPolicy.getName() + "].",
            realmName);
    }
}