 ...
 */
@XmlRootElement
public final class CompuwareSecurityUserDeletedEvent extends CompuwareSecurityUserEvent {
     ...
     * 
     */
    protected CompuwareSecurityUserDeletedEvent() {
        super();
    }
     ...
     * @param realmName
     */
    public CompuwareSecurityUserDeletedEvent(
        ...
        super(
            ...
            originatingHostname,
            "Deleted " + abstractUser.getClass().getSimpleName() + ": [" + abstractUser.getUsername() + "].",
            realmName);
    }
}