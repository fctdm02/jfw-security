 ...
 * @author tmyers
 */
public final class DerbyAclSql extends AclSql {
	...
	public String getIdentityClause() {
		return "generated always as identity(START WITH 100, INCREMENT BY 1)";
	}
	...
	public String getDeleteOldAuditEventSql() {
	    return "DELETE FROM AUDIT_EVENT WHERE EVENT_DATE < DATE('{0}')";
	}
}